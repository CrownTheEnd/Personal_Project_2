...
def apply_heal(fighter_stats):
    """Apply heal effect which reduces incoming damage."""
    fighter_stats['damage_reduction'] = 1  # Reduce incoming damage by 1
